...
import tutoringImage from 'assets/images/selfEducation.png';
    ...
    <div className="bg-white flex min-h-screen w-full">
      <div className="w-full md:w-[40%] p-4 md:px-8 overflow-y-auto scrollbar">
        ...
        <h1 className="text-xl md:text-2xl font-semibold tracking-wide">
          We are starting to know each other better
        </h1>
        <RegisterTutorForm />
      </div>
      <div
        className="hidden md:block w-[60%] p-32 bg-center bg-cover bg-no-repeat"
        style={{ backgroundImage: `url(${tutoringImage})` }}
      >
...
export default RegisterTutorActivity;
